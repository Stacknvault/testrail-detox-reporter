...
const get_plans = {
  type: "object",
  required: ["offset", "limit", "size", "_links", "plans"],
  properties: {
    offset: {
      type: "integer",
    },
...
const get_milestones = {
  type: "object",
  required: ["offset", "limit", "size", "_links", "milestones"],
  properties: {
    offset: {
      type: "integer",
    },
...
const get_runs = {
  type: "object",
  required: ["offset", "limit", "size", "_links", "runs"],
  properties: {
    offset: {
      type: "integer",
    },
...
const get_tests = {
  type: "object",
  required: ["offset", "limit", "size", "_links", "tests"],
  properties: {
    offset: {
      type: "integer",
    },
